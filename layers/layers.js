...
var lyr_Road01_1 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Road01<br />\
    <img src="styles/legend/Road01_1_0.png" /> -16<br />\
    <img src="styles/legend/Road01_1_1.png" /> 0<br />\
    <img src="styles/legend/Road01_1_2.png" /> 3<br />\
    <img src="styles/legend/Road01_1_3.png" /> 4<br />\
    <img src="styles/legend/Road01_1_4.png" /> 6<br />\
    <img src="styles/legend/Road01_1_5.png" /> 7<br />\
    <img src="styles/legend/Road01_1_6.png" /> 13<br />\
    <img src="styles/legend/Road01_1_7.png" /> 20<br />\
    <img src="styles/legend/Road01_1_8.png" /> 23<br />\
    <img src="styles/legend/Road01_1_9.png" /> 26<br />\
    <img src="styles/legend/Road01_1_10.png" /> 27<br />\
    <img src="styles/legend/Road01_1_11.png" /> <br />' });
...
lyr_WardBoundary_0.set('fieldLabels', {'gml_parent': 'no label', 'gml_pare_1': 'no label', 'gml_id': 'no label', 'geom': 'no label', 'District': 'inline label - always visible', 'LSGD': 'no label', 'Ward_Name': 'inline label - always visible', 'Ward_No': 'header label - visible with data', 'Lsgd_Type': 'no label', 'Created_Da': 'no label', 'Surveyor': 'no label', 'Mob_No': 'no label', 'Remarks': 'no label', '_distLsgd': 'no label', 'OBJECTID': 'no label', '_result': 'no label', '_ulid': 'no label', '_distLsgd2': 'no label', });
lyr_Road01_1.set('fieldLabels', {'osm_id': 'no label', 'name': 'inline label - always visible', 'highway': 'inline label - visible with data', 'waterway': 'inline label - always visible', 'aerialway': 'no label', 'barrier': 'no label', 'man_made': 'no label', 'railway': 'no label', 'z_order': 'no label', 'other_tags': 'no label', });
